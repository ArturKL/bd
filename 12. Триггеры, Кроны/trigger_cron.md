...
Расширение `pg_cron` требует системной установки и не устанавливается автоматически. После установки на уровне системы выполните в базе данных:
...
- **macOS (Homebrew):** `brew install pg_cron`
- **Linux (Debian/Ubuntu):** `apt-get install postgresql-17-pg-cron` (версия зависит от версии PostgreSQL)
- **Другие системы:** см. документацию pg_cron

Если расширение не установлено, запросы на создание и просмотр кронов не будут работать. Триггеры работают независимо от `pg_cron`.

### 1. Ежедневное обновление статистики enrollment

Автоматически обновляем статистику по зачислениям каждый день в полночь.
...
### 2. Еженедельная очистка старых логов

Удаляем старые записи из таблиц логов каждую неделю в понедельник в 02:00 (enrollment_log старше 30 дней, user_deletion_log старше 90 дней, assignment_operation_log старше 30 дней).
...
### 3. Ежечасная проверка и обновление статуса flow

Каждый час проверяем потоки и автоматически обновляем их статус: завершаем активные потоки с истекшей датой окончания и активируем запланированные потоки, у которых наступила дата начала.
...
Получаем список всех настроенных кронов с их расписанием и командами.

**Примечание:** Требуется установленное расширение `pg_cron` (устанавливается в `init_tables.sql`). Если расширение не установлено, используйте альтернативный запрос ниже.
...
| jobid | schedule | jobname | active | database | username |
|-------|----------|---------|--------|----------|----------|
| 1 | 0 0 * * * | daily-enrollment-statistics | true | postgres | postgres |
| 2 | 0 2 * * 1 | weekly-cleanup-logs | true | postgres | postgres |
| 3 | 0 * * * * | hourly-flow-status-update | true | postgres | postgres |

---

### Просмотр истории выполнения кронов

Смотрим историю выполнения всех кронов за последнее время (последние 50).

**Примечание:** Требуется установленное расширение `pg_cron`.
...
| jobid | runid | job_pid | status | start_time | end_time | return_message |
|-------|-------|---------|--------|------------|----------|----------------|
| 1 | 101 | 12345 | succeeded | 2025-01-20 00:00:00+03 | 2025-01-20 00:00:01+03 | INSERT 0 1 |
| 3 | 100 | 12340 | succeeded | 2025-01-19 23:00:00+03 | 2025-01-19 23:00:00+03 | UPDATE 0 |
| 3 | 99 | 12335 | succeeded | 2025-01-19 22:00:00+03 | 2025-01-19 22:00:00+03 | UPDATE 0 |
| 2 | 98 | 12330 | succeeded | 2025-01-19 02:00:00+03 | 2025-01-19 02:00:02+03 | DELETE 5 |
| 1 | 97 | 12325 | succeeded | 2025-01-19 00:00:00+03 | 2025-01-19 00:00:01+03 | INSERT 0 1 |
| 3 | 96 | 12320 | succeeded | 2025-01-19 21:00:00+03 | 2025-01-19 21:00:00+03 | UPDATE 0 |

---

### Просмотр последних выполнений конкретного крона

Получаем информацию о последних 10 выполнениях крона (daily-enrollment-statistics).
...
| jobname | status | start_time | end_time | return_message |
|---------|--------|------------|----------|----------------|
| daily-enrollment-statistics | succeeded | 2025-01-20 00:00:00+03 | 2025-01-20 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-19 00:00:00+03 | 2025-01-19 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-18 00:00:00+03 | 2025-01-18 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-17 00:00:00+03 | 2025-01-17 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-16 00:00:00+03 | 2025-01-16 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-15 00:00:00+03 | 2025-01-15 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-14 00:00:00+03 | 2025-01-14 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-13 00:00:00+03 | 2025-01-13 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-12 00:00:00+03 | 2025-01-12 00:00:01+03 | INSERT 0 1 |
| daily-enrollment-statistics | succeeded | 2025-01-11 00:00:00+03 | 2025-01-11 00:00:01+03 | INSERT 0 1 |
