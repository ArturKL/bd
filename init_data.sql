...
-- Для воспроизводимости результатов на защите фиксируем created_at/updated_at
-- (иначе значения по умолчанию now() будут отличаться при каждом прогоне).
INSERT INTO "user" (full_name, email, phone, unit_id, student_number, employee_position, status, last_login_at, created_at, updated_at) VALUES
('Иванов Иван Иванович', 'ivanov@student.university.edu', '+7-999-111-22-33', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-001', NULL, 'active', '2025-01-15 10:30:00+03', '2025-01-15 10:30:00+03', '2025-01-15 10:30:00+03'),
('Петрова Мария Сергеевна', 'petrova@student.university.edu', '+7-999-111-22-34', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-002', NULL, 'active', '2025-01-15 11:20:00+03', '2025-01-15 11:20:00+03', '2025-01-15 11:20:00+03'),
('Сидоров Алексей Дмитриевич', 'sidorov@student.university.edu', '+7-999-111-22-35', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-003', NULL, 'active', '2025-01-14 09:15:00+03', '2025-01-14 09:15:00+03', '2025-01-14 09:15:00+03'),
('Козлова Анна Владимировна', 'kozlova@student.university.edu', '+7-999-111-22-36', 
    (SELECT id FROM unit WHERE code = 'IGH'), 'ST-2023-004', NULL, 'active', '2025-01-15 14:45:00+03', '2025-01-15 14:45:00+03', '2025-01-15 14:45:00+03'),
('Михайлов Дмитрий Петрович', 'mikhailov@student.university.edu', '+7-999-111-22-37', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-005', NULL, 'active', '2025-01-15 10:00:00+03', '2025-01-15 10:00:00+03', '2025-01-15 10:00:00+03'),
('Федорова Елена Ивановна', 'fedorova@student.university.edu', '+7-999-111-22-38', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-006', NULL, 'active', '2025-01-15 11:00:00+03', '2025-01-15 11:00:00+03', '2025-01-15 11:00:00+03'),
('Соколов Сергей Александрович', 'sokolov@student.university.edu', '+7-999-111-22-39', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-007', NULL, 'active', '2025-01-14 12:00:00+03', '2025-01-14 12:00:00+03', '2025-01-14 12:00:00+03'),
('Новиков Андрей Викторович', 'novikov@student.university.edu', '+7-999-111-22-40', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-008', NULL, 'active', '2025-01-15 13:00:00+03', '2025-01-15 13:00:00+03', '2025-01-15 13:00:00+03'),
('Кузнецова Ольга Сергеевна', 'kuznetsova@student.university.edu', '+7-999-111-22-41', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-009', NULL, 'active', '2025-01-15 14:00:00+03', '2025-01-15 14:00:00+03', '2025-01-15 14:00:00+03'),
('Лебедев Максим Дмитриевич', 'lebedev@student.university.edu', '+7-999-111-22-42', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-010', NULL, 'active', '2025-01-14 15:00:00+03', '2025-01-14 15:00:00+03', '2025-01-14 15:00:00+03'),
('Попова Татьяна Алексеевна', 'popova@student.university.edu', '+7-999-111-22-43', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-011', NULL, 'active', '2025-01-15 16:00:00+03', '2025-01-15 16:00:00+03', '2025-01-15 16:00:00+03'),
('Волков Игорь Николаевич', 'volkov@student.university.edu', '+7-999-111-22-44', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-012', NULL, 'active', '2025-01-14 17:00:00+03', '2025-01-14 17:00:00+03', '2025-01-14 17:00:00+03'),
('Семенова Юлия Валерьевна', 'semenova@student.university.edu', '+7-999-111-22-45', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-013', NULL, 'active', '2025-01-15 18:00:00+03', '2025-01-15 18:00:00+03', '2025-01-15 18:00:00+03'),
('Васильев Роман Олегович', 'vasiliev@student.university.edu', '+7-999-111-22-46', 
    (SELECT id FROM unit WHERE code = 'IMI'), 'ST-2023-014', NULL, 'active', '2025-01-14 19:00:00+03', '2025-01-14 19:00:00+03', '2025-01-14 19:00:00+03'),
('Павлова Наталья Игоревна', 'pavlova@student.university.edu', '+7-999-111-22-47', 
    (SELECT id FROM unit WHERE code = 'IGH'), 'ST-2023-015', NULL, 'active', '2025-01-15 20:00:00+03', '2025-01-15 20:00:00+03', '2025-01-15 20:00:00+03'),
('Смирнов Петр Николаевич', 'smirnov@teacher.university.edu', '+7-999-222-33-44', 
    (SELECT id FROM unit WHERE code = 'MATH'), NULL, 'Профессор', 'active', '2025-01-15 08:00:00+03', '2025-01-15 08:00:00+03', '2025-01-15 08:00:00+03'),
('Волкова Елена Александровна', 'volkova@teacher.university.edu', '+7-999-222-33-45', 
    (SELECT id FROM unit WHERE code = 'CS'), NULL, 'Доцент', 'active', '2025-01-15 09:30:00+03', '2025-01-15 09:30:00+03', '2025-01-15 09:30:00+03'),
('Морозов Дмитрий Сергеевич', 'morozov@teacher.university.edu', '+7-999-222-33-46', 
    (SELECT id FROM unit WHERE code = 'CS'), NULL, 'Старший преподаватель', 'active', '2025-01-14 16:20:00+03', '2025-01-14 16:20:00+03', '2025-01-14 16:20:00+03'),
('Новикова Ольга Ивановна', 'novikova@teacher.university.edu', '+7-999-222-33-47', 
    (SELECT id FROM unit WHERE code = 'HIST'), NULL, 'Доцент', 'active', '2025-01-13 12:10:00+03', '2025-01-13 12:10:00+03', '2025-01-13 12:10:00+03');
...
INSERT INTO flow (code, title, discipline_id, unit_id, owner_id, credits, cohort_year, modality, language, start_date, end_date, add_drop_deadline, exam_window_start, exam_window_end, grade_submit_deadline, max_students, status) VALUES
...
INSERT INTO enrollment (user_id, flow_id, enrolled_at, attendance_pct, current_score, final_grade, status) VALUES
