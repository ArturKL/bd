-- =========================
-- ФАЙЛ НОРМАЛИЗАЦИИ БД
-- =========================
-- ВНИМАНИЕ: Этот файл содержит команды для нормализации существующей БД
-- Используйте init_correct.sql для создания БД с уже нормализованной структурой
-- 
-- Этот файл предназначен для применения изменений к БД, созданной из University.sql
-- Все команды безопасны для выполнения в pgAdmin (используют IF EXISTS)
